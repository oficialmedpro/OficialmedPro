...
API para sincronização automática de leads do SprintHub com Supabase.

## 🚀 Funcionalidades

- Sincronização automática de leads do SprintHub
...
```bash
# Build
docker build -t oficialmedpro/sync-leads-api:latest .
...
docker run -p 3001:3001 \
  ...
  oficialmedpro/sync-leads-api:latest
```
...
```bash
0,30 * * * * curl -X POST https://sincro.oficialmed.com.br/leads/sync \
  -H "Authorization: Bearer sync-leads-2025-aB3cD7eF9gH2jK5mN8pQ1rS4tU7vW0xY"
```
