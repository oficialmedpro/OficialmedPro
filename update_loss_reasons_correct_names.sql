-- =====================================================
-- SCRIPT PARA ATUALIZAR NOMES DOS MOTIVOS DE PERDA
-- =====================================================
-- Execute este script no Supabase SQL Editor
-- Este script exclui os dados antigos e insere os novos com nomes corretos

-- 1. Verificar se a tabela existe no schema api
SELECT schemaname, tablename FROM pg_tables WHERE tablename = 'loss_reasons';

-- 2. Excluir todos os dados existentes da tabela loss_reasons no schema api
DELETE FROM api.loss_reasons;

-- 3. Inserir os dados corretos com nomes completos (incluindo [número])
-- Funil 0
...
-- 5. Mostrar todos os motivos inseridos para verificação
SELECT 
    id,
    name,
    funil_id,
