...
const PerformanceRondaPage = ({ onLogout }) => {
  ...
  const handleUnitFilterChange = (filterValue) => {
    ...
    console.log(`🎯 Performance Ronda: Filtro de unidade alterado para:`, filterValue);
  ...
  const handleStatusFilterChange = (filterData) => {
    ...
    console.log(`🎯 Performance Ronda: Filtro de status alterado para:`, filterData);
  ...
  const handleSellerFilterChange = (filterValue) => {
    console.log(`🎯 Performance Ronda: Filtro de vendedor alterado para:`, filterValue);
  ...
  const handleOriginFilterChange = (filterValue) => {
    console.log(`🎯 Performance Ronda: Filtro de origem alterado para:`, filterValue);
...
export default PerformanceRondaPage;