...
import OrcamentosCards from '../components/OrcamentosCards';
...
const OrcamentosTempoEtapaPage = ({ onLogout }) => {
    ...
    <div className="dashboard-container">
      ...
      <main className="main-content">
          ...
          <div className="orcamentos-page-header">
            <h1 className="orcamentos-page-title">Quantidade de orçamentos</h1>
          </div>
...
export default OrcamentosTempoEtapaPage;
