...
import SellerRankingReal from '../components/SellerRankingReal';
import { translations } from '../data/translations';
import { getStatsCards } from '../data/statsData';
import {
  formatCurrency,
  updateMarketData,
  fetchUsdRate,
...
const RankingDePerformancePage = ({ onLogout }) => {
  ...
  return (
    <div className="dashboard-container">
      ...
      <main className="main-content">
          {/* Metrics Cards Section - mostra ranking geral por padrão, filtra quando unidade selecionada */}
          <MetricsCards
...
export default RankingDePerformancePage;