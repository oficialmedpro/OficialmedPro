-- =====================================================
-- SCRIPT PARA INSERIR DADOS NA TABELA LOSS_REASONS NO SCHEMA API
-- =====================================================
-- Execute este script no Supabase SQL Editor
-- Este script insere os dados diretamente no schema api

-- 1. Criar a tabela no schema api (se não existir)
...
-- 5. Mostrar todos os motivos inseridos
SELECT 
    id,
    name,
    funil_id,
