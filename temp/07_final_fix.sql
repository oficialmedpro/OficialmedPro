-- ====================================================
-- INSERÇÃO FINAL CORRIGIDA NA TABELA api.unidades  
-- ====================================================

-- 1. Alterar o campo telefone_franqueado para 100 caracteres
ALTER TABLE api.unidades 
ALTER COLUMN telefone_franqueado TYPE VARCHAR(100);

-- 2. Adicionar o campo codigo_sprint com tamanho adequado
ALTER TABLE api.unidades 
...
-- 4. Inserir dados das franquias com códigos corretos
...
SELECT id, codigo_sprint, nome, cidade, status 
FROM api.unidades 
