-- =====================================================
-- CONFIGURAÇÃO COMPLETA FINAL - GOOGLE ADS
-- =====================================================
-- 
-- EXECUTE ESTE SCRIPT NO SUPABASE DASHBOARD > SQL EDITOR
-- 
-- Baseado nos testes realizados, configurando apenas as contas que funcionam
-- e têm campanhas ativas.
--
-- =====================================================
...
-- Configurar outras unidades com contas específicas que funcionam e têm campanhas
-- (Baseado nos testes realizados)

-- OficialMed Apucarana (ID=3) - 10 campanhas ativas
UPDATE api.unidades 
SET 
...
-- Franchising - Oficial Med (ID=4) - 4 campanhas ativas  
UPDATE api.unidades 
SET 
...
-- 3  | BOM JESUS              | 8802039556     | ✅ Configurado | true  
-- 4  | BELO HORIZONTE         | 7939953031     | ✅ Configurado | true
--
-- =====================================================
-- 
-- CONTAS CONFIGURADAS:
...
-- 
-- 2. BOM JESUS (ID=3) 
--    - Customer ID: 8802039556 (OficialMed Apucarana)
--    - Tipo: Conta de anúncios
--    - Campanhas: 10 campanhas ativas
--    - Exemplos: Leads OMS, P-Max OMS
-- 
-- 3. BELO HORIZONTE (ID=4)
--    - Customer ID: 7939953031 (Franchising - Oficial Med)
--    - Tipo: Conta de anúncios  
--    - Campanhas: 4 campanhas ativas
--    - Exemplos: Campaign #1, Leads Franquia
--
-- =====================================================
-- 
...
-- 
-- 5. Contas disponíveis para uso:
--    - Manager: 739-617-8858 (acessa todas as contas)
--    - Apucarana: 8802039556 (10 campanhas)
--    - Franchising: 7939953031 (4 campanhas)
--
-- =====================================================
